...
import { getUploadData } from '@/api/openShop';
    ...
    handleSubmit() {
      this.$refs.setUpShop.validate(res => {
        if (res) {
          ...
          formData.append('storeJoininAddress',this.business)
          formData.append('businessLicense',this.account)
          formData.append('idCard',this.identityCard)
          formData.append('accountOpeningPermit',this.food)
          ...
          // console.log(formData.get("accountOpeningPermit"));
          // console.log(formData.get("storeJoininMobile"));
