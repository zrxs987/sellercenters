<template>
 ...
 <div class="filter-container">
    ...
    >
      <el-table-column align="center" label="订单编号" prop="goodsId">
      </el-table-column>
      <el-table-column label="商品名称" align="center" prop="goodsName">
      </el-table-column>
      <el-table-column label="金额"  align="center" prop="goodsPrice">
      </el-table-column>
      <el-table-column align="center" label="时间" prop="goodsId">
      </el-table-column>
...
<script>
import { gitCommodityList } from '@/api/commodity'
...
methods: {
 ...
 _gitCommodityList(){
    ...
    gitCommodityList({storeId:'1'}).then((res) => {
      this.loading=true;
          if (res.code === '200') {
              this.loading=false;
