    ...
    <div>
         <el-col :span="24">
                        ...
                        <div style="position:relative;overflow:hidden;" :style="styles">
                            ...
                            <div style=" color: rgba(0, 0, 0, 1);padding-top:20px;"  v-show="!show">  &nbsp;  &nbsp; &nbsp;</div>
                            <div style=" color: rgba(0, 0, 0, 1);padding-top:20px;"  v-show="show">  &nbsp;  &nbsp; &nbsp;{{title}}</div>
                            <div style=" color: rgba(0, 0, 0, 0.45);"> &nbsp;  &nbsp; &nbsp;{{support}}</div>  
                        </div> 
            </el-col>
    </div>
</template>
